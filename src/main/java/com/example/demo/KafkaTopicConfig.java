...
public class KafkaTopicConfig
{
    ...
    public KafkaAdmin kafkaAdmin() {
        ...
        //The class AdminClientConfigs is part of Apache kafka library and AdminClientConfig
        // .BOOTSTRAP_SERVERS_CONFIG returns the string "bootstrap.servers"
        configs.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        //the class KafkaAdmin is part of Spring framework.
        return new KafkaAdmin(configs);
    }

    @Bean // NewTopic is part of Apache kafka library
    public NewTopic topic1() {
        //3-arg NewTopic constructor gets 3 arguments: topic name, number of partitions, and
        // replication factor.
